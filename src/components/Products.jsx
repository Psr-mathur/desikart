...
const Product = ({ item }) => {
	return (
		<div className="flex-1 min-w-[275px] h-96 m-2 flex flex-col items-center justify-center bg-sky-50 shadow relative group transition-all">
			...
			<div className="w-[calc(100%-16px)] py-2 peer">
				...
				<div className=" flex items-center justify-between mt-1">
					<p className="flex items-center">
						...
						<span className=" text-[18px]">{item.price * 10}</span>
					</p>
